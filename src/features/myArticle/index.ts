...
export default function registerMyArticle(context: vscode.ExtensionContext) {
  const fsProvider = new myArticleFsProvider('luogu-myarticle');
  context.subscriptions.push(
    vscode.workspace.registerFileSystemProvider('luogu-myarticle', fsProvider)
  );
  const view = new MyArticleTreeviewProvider(fsProvider);
